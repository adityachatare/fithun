...
class ResultEdit {
    ...
    var additionalDetails: AdditionalDeta? = AdditionalDeta()
    ...
    var isUPIVerified: Boolean? = false
    ...
    var deviceToken: ArrayList<String> = arrayListOf()
    ...
    @SerializedName("mobileLinkedWithUpi")
    var mobileLinkedWithUpi: String? = ""
...
class AdditionalDeta {
    ...
    @SerializedName("physicallyChallenged")
    var physicallyChallenged: String? = ""

    @SerializedName("ableToWalk")
    var ableToWalk: Boolean? = false
